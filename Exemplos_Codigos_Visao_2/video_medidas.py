...
def processar_frame(frame, largura=10.00, pixels_por_metrica=None):
    frame = cv2.resize(frame, (310 , 640)) 

    hsv = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)
    azul_baixo = np.array([20, 100, 100])  #amarelo
    azul_alto = np.array([40, 255, 255])  #amarelo
